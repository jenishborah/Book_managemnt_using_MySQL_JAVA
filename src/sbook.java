 ...
 * @author jenis
 */
public class sbook extends javax.swing.JFrame {

    /**
     * Creates new form sbook
     */
    public sbook() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(sbook.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
